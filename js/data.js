...
const DATA = {
  ...
  finale: {
    ...
    letter: [
      ...
      "I think about our first Halloween — you drawing fake scars on our faces, laughing at how seriously I took mine. Lighting up Diwali together, you in that green, me forgetting whatever I was about to say. Your birthday, when I learned that celebrating you might be my favourite thing in the world. And the party you secretly planned for mine — balloons, banner, tiara, everything — when I understood, properly, what it feels like to be loved the way you love.",
